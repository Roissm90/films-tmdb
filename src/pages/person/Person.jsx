  ...
  if (!director) {
    return (
      <div className="director-page error">
        <p>No se encontró información para este director.</p>
      </div>
    );
  }
      ...
      <section className="director-page">
        ...
        <div className="director-header">
          ...
          <div className="director-info">
            ...
            <p className="paragraph text-light-grey">Fecha de nacimiento: {director.birthday || "-"}</p>
            <p className="paragraph text-light-grey">Lugar de nacimiento: {director.place_of_birth || "-"}</p>
            {director.biography && <p className="paragraph text-light-grey">{director.biography}</p>}
          </div>
        </div>

        <div className="movies-section">
          <h2 className="title-section text-light-grey">
            {director.known_for_department === "Directing" ? 'Películas dirigidas' : 'Películas'}
          </h2>
